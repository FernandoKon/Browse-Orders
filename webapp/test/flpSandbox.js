		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Browse Orders",
									"targetURL": "#comlab2devbrowseorders-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comlab2devbrowseorders-display": {
								"semanticObject": "comlab2devbrowseorders",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.lab2dev.browseorders",
									"url": sap.ui.require.toUrl("com/lab2dev/browseorders")
								}
							}
						}
					}
